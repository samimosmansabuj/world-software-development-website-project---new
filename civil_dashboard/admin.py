...
admin.site.register(Civil_TwoCardCustomerFeedback)
admin.site.register(Civil_ThreeCardSection)
admin.site.register(Civil_FourCardSection)
...
admin.site.register(Civil_Office_Address)
...
admin.site.register(Civil_Footer_Section_Topics)
